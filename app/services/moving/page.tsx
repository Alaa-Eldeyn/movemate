...
import { IMoving, movingSchema } from "@/app/validations/Order";
...
const page = () => {
  ...
  const onSubmit: SubmitHandler<IMoving> = async ({
    firstName,
    lastName,
    email,
    phoneNumber,
  ...
  const serviceArr = [
    ...
    {
      idTag: "movingLocation",
      type: "text",
      placeholder: "Umzugsort",
      error: errors.movingLocation,
      register: register("movingLocation"),
      isTextArea: false,
    },
    {
      idTag: "movingFloor",
      type: "number",
      placeholder: "Umzugsort Etage",
      error: errors.movingFloor,
      register: register("movingFloor"),
      isTextArea: false,
      steps: 1,
    },
    {
      idTag: "placeOfEntry",
      type: "text",
      placeholder: "Einzugsort",
      error: errors.placeOfEntry,
      register: register("placeOfEntry"),
      isTextArea: false,
    },
    {
      idTag: "moveInFloor",
      type: "number",
      placeholder: "Einzugsort Etage",
      error: errors.moveInFloor,
      register: register("moveInFloor"),
      isTextArea: false,
      steps: 1,
    },
    {
    ...
    },
    {
      idTag: "movingDate",
      type: "date",
      placeholder: "Umzugstermin",
      error: errors.movingDate,
      register: register("movingDate"),
      isTextArea: false,
    },
    {
      idTag: "notes",
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-5 pb-12">
            ...
            >
              <Image
                src={img}
                alt={label}
                className="rounded-lg w-full lg:max-w-[550px] max-w-[400px] max-h-[300px] object-cover border-4 border-transparent hover:border-primary soft"
              />
            </motion.div>
            <motion.div
