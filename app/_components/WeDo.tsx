      ...
      <div className="section section-lg text-center pb-24" id="our-services">
        <div className="container">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 mt-3 text-center sm:mt-10 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-2 lg:grid-cols-3 md:gap-0 xl:mt-10 justify-center items-center">
                ...
                return (
                  <MotionDiv
                    ...
                    className={`soft md:px-8 lg:px-14 pt-10 pb-4 md:border-gray-200 flex flex-col justify-center items-center group hover:bg-primary rounded-lg ${
                      item.id <= 3 ? "lg:border-b" : ""
                    } ${item.id == 2 ? "lg:border-x" : ""}${
                      item.id == 5 ? "lg:border-x" : ""
                    } `}
                  >
