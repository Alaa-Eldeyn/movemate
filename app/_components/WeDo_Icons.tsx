                ...
                return (
                  ...
                  >
                    <Link href={`/services/${item.title}`}>
                      <div className="shadow-md soft flex flex-col justify-center items-center group border hover:bg-primary hover:scale-110 rounded-lg p-8">
                        ...
                        <h3 className="mt-3 text-xl font-bold group-hover:text-white text-gray-900 line-clamp-1">
                          {item.title}
                        </h3>
                      </div>
                    </Link>
